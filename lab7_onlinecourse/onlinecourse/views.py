...
def enroll(request, course_id):
    ...
    if request.method == 'POST':
        ...
        course.save()
        # Return a HTTP response redirecting user to course list view (same url, just rerender the enrollment number)
        # return HttpResponseRedirect(reverse(viewname='onlinecourse:popular_course_list'))
        # Updated to redirect user to the web page generated by course_details view.
