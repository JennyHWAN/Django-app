...
class Instructor(User):
    full_time = models.BooleanField(default=True) # addition field other than User model
...
class Learner(User):
    ...
    def __str__(self):
        # return "Learner is a/an: {}".format(occupation.choices)
        return "First name: " + self.first_name + ", " + \
                "Last name: " + self.last_name + ", " \
...
class Course(models.Model):
    ...
    # Creating a ManyTo ManyField field called instructors
...
class Lesson(models.Model):
    ...
    # By default, Django gives each model an auto-incrementing 
    # primary key with the type specified per app in AppConfig.default_auto_field 
